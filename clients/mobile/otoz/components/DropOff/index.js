...
export class DropOff extends Component {
  constructor(props) {
    ...
    this._DropOffClicked = this._DropOffClicked.bind(this);
  }
  ...
  _DropOffClicked() {
    ...
    fetch(Routes.DROP_OFF_CAR, {
      ...
      console.log("DROP_OFF_CAR: Successful:");
      console.log(jsonResponse);
      Alert.alert("Drop Off", "Drop off successful");
            ...
            <ImageBackground style={{width: 375, height: 500, alignSelf: 'center', marginTop: 20}} imageStyle={{resizeMode: 'contain'}} source={require('../../assets/images/images/ticket.png')}>
              <View style={{flex: 1, paddingVertical: 40, paddingHorizontal: 40}}>
                ...
                <View style={{paddingTop: 20, alignItems: 'center'}}>
                  <TouchableOpacity style={[globalCss.btn, {width: 150}]} onPress={this._DropOffClicked}>
                    <Text style={globalCss.btnText}>DROP OFF</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </ImageBackground>
