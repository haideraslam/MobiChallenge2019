...
@Component({
  selector: 'app-allocate-car-manufacturer',
  templateUrl: './allocate-car-manufacturer.component.html',
  styleUrls: ['./allocate-car-manufacturer.component.css']
})
export class AllocateCarManufacturerComponent implements OnInit {
  ...
  constructor(private allocateCarService: AllocateCarService) {
    this.options = [
      { label: 'Select a Finance Company', value: null }
    ];
  }
